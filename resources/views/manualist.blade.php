...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
	...
	<input required="" type="file" name="manual_file"  class="form-control" id="manual_file" />
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
				...
				<div class="alert alert-danger" id='editmanualmessage'> </div>
                    ...
                    <div class="form-group">
                        <label for="manual" class="form-control-label">Manual:</label>
                        <input type="text" required='required' class="form-control" id="manualEdit" name="manualEdit">
	...
	<input  type="file" name="manual_fileEdit"  class="form-control" id="manual_fileEdit" />
        ...
        $('#manualedit').on('submit', function(e) {
          ...
          //  var courseid = $('#courseId').val();    		
           // var description = $('#description').val(); qmsdesc
            ...
            var manualEdit = $('#manualEdit').val();			
			var qmsdescEdit = $('#qmsdescEdit').val();
			  var form_data = new FormData();
			
        form_data.append('file', file_data);
		form_data.append('title', manualEdit);
