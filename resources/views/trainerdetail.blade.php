						...
						<div class="kt-subheader  kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><i class="kt-font-brand flaticon-presentation-1"></i> &nbsp; Trainer Details</h3> 
                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                    	...
                    	<div class="kt-portlet__body">
												<div class="form-group form-group-xs row">
													...
													<label class="col-2 col-form-label">Trainer Name:</label>
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Trainer['name']}}	</span>
													</div>
												</div>	<!--
												<div class="form-group form-group-xs row">
													<label class="col-2 col-form-label"></label>
													...
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Trainer['last_name']}}	</span>
													</div>
												</div>
												-->
												<div class="form-group form-group-xs row">
													...
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Trainer['dob']}}</span>
													</div>
												</div>
												<!--<div class="form-group form-group-xs row">
													<label class="col-2 col-form-label"></label>
												...
												<?php	if($Trainer['photo_path'] ==''){
														...
														$imageFullPath = '../userimage/'. $Trainer['photo_path']; 
													}
												?>
												...
												<div class="form-group form-group-xs row">
													...
													<label class="col-2 col-form-label">Photo Path:</label>
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Trainer['photo_path']}}	</span>
													</div>
												</div>
												<div class="form-group form-group-xs row"><label class="col-2 col-form-label"></label>
													<label class="col-2 col-form-label">Phone:</label>
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Trainer['phone']}}</span>
													</div>
												</div>
												<div class="form-group form-group-xs row">
													<label class="col-2 col-form-label"></label>
