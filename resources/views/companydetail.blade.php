						...
						<div class="kt-subheader  kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title"><i class="kt-font-brand flaticon2-group"></i> &nbsp; Company Details</h3> 
                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                    	...
                    	<div class="kt-portlet__body">
												...
												<!--<div class="form-group form-group-xs row">
													...
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Company['last_name']}}	</span>
													</div>
												</div>
												...
												<div class="form-group form-group-xs row">
													...
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Company['dob']}}</span>
													</div>
												</div>-->
												<!--<div class="form-group form-group-xs row">
													<label class="col-2 col-form-label"></label>
