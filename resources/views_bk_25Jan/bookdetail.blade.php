						...
						<div class="kt-subheader  kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">Book Details</h3> 
                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                    	...
                    	<div class="kt-portlet__body">
												...
												<div class="form-group form-group-xs row">
													...
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Book['course_id']}}	</span>
													</div>
												</div>
												...
												<div class="form-group form-group-xs row">
													<label class="col-2 col-form-label"></label>
													<label class="col-2 col-form-label">Book Path:</label>
													<div class="col-8">
														<span class="form-control-plaintext kt-font-bolder">{{$Book['bookpath']}}	</span>
													</div>
												</div>
