			...
			columns: [
				{
					...
					template: function(row) {
						return '\
						<a href="javascript:;" data-id='+row.id+'  data-name='+row.name+'  data-email='+row.email+' data-roles='+row.userRoles+' data-toggle="modal" data-target="#useredit_modal" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">\
