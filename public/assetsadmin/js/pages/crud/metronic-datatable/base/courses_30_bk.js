			...
			columns: [
				{
					...
					template: function(row) {
						return '\
						<a href="javascript:;" data-id='+row.id+'   data-name="'+row.name+'"   data-description="'+row.description+'" data-toggle="modal" data-target="#courseedit_modal" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">\
