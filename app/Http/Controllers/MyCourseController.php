...
class MyCourseController extends Controller
{
    ...
    {
       // $pages = Pages::all();	
        $Courses = MyCourses::where('is_deleted', '=', '0')->orderBy('id', 'ASC' )->get();
	
        return view('mycourselist', compact('Courses'));
    }
	...
	function ajaxmycourselist(Request $request){
		$data = $request->all();
